...
public class GeneralService {
	 ...
	 * @param map
	 */
	public void selUserDetail(String userId, Integer pageNo, Integer pageNum, Map<String, Object> map) {
		// TODO Auto-generated method stub
		String hql = "from UserIntergral ui where ui.userId = "+Integer.parseInt(userId);
		PageUtil pu = hdb.findHql(hql, pageNo, pageNum);
