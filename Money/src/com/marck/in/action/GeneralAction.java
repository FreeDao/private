	...
	*/
	public String wp(){
		try {
			...
			Jpush.SendPush(userId, "万普平台"+points+"积分已到帐");
	...
	public String jp(){
		try {
			...
			Jpush.SendPush(userId, "巨朋平台"+points+"积分已到帐");
	...
	public String dl(){
		try {
			...
			Jpush.SendPush(userId, "点乐平台"+points+"积分已到帐");
	...
	public String md(){
		try {
			...
			Jpush.SendPush(userId, "迷迪平台"+points+"积分已到帐");
	...
	public String dm(){
		try {
			...
			Jpush.SendPush(userId, "多盟平台"+points+"积分已到帐");
	...
	public String mp(){
		try {
			...
			Jpush.SendPush(userId, "磨盘平台"+points+"积分已到帐");
	...
	public String zm(){
		try {
			...
			Jpush.SendPush(userId, "指盟平台"+points+"积分已到帐");
	...
	public String yjf(){
		try {
			...
			Jpush.SendPush(userId, "易积分平台"+points+"积分已到帐");
	...
	public String xy(){
		try {
			...
			Jpush.SendPush(userId, "行云平台"+points+"积分已到帐");
	...
	public String gm(){
		try {
			...
			Jpush.SendPush(userId, "果盟平台"+points+"积分已到帐");
	...
	public String dr(){
		try {
			...
			Jpush.SendPush(userId, "点入平台"+points+"积分已到账");
	...
	public String ym(){
		try {
			...
			Jpush.SendPush(userId, "有米平台"+points+"积分已到账");
	...
	public String yy(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,14,map);
			
			Jpush.SendPush(userId, "鹰眼平台,应用《"+CommonUtil.changeIos8859ToUtf8(adname)+"》获得"+points+"积分");
