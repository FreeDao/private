...
public class QueryService {
	...
	public PageUtil findApplyList(String queryValue, Integer pageNow,
		...
		if(!CommonUtil.validParams(queryValue)){
			hql += " and ( a.account like '%"+queryValue+"%' or  a.id like '%"+queryValue+"%' or a.userId like '%"+queryValue+"%' or a.alipay like '%"+queryValue+"%'  or a.num like '%"+queryValue+"%'  or a.name like '%"+queryValue+"%' or a.addTime like '%"+queryValue+"%' or u.phone like '%"+queryValue+"%') ";
		}
