                                ...
                                <c:forEach items="${pu.data }" var="pd" >
                                	...
                                	<tr class="${temp }" style="height: 50px;" >
	                                    ...
	                                    <td>
	                                     ...
	                                     <td>
	                                     	<c:choose>
	                                     		<c:when test="${pd.recommend == null || pd.recommend == '' }">
	                                     			<div class="slider-frame primary">
	                                     				<span data-on-text="开启" data-off-text="关闭" class="slider-button on" style="margin-top: 0px;" value="${pd.id }" >开启</span>
	                                     			</div>
	                                     		</c:when>
	                                     		<c:otherwise>
		                                     		<div class="slider-frame primary">
						                                <span data-on-text="开启" data-off-text="关闭" class="slider-button " style="margin-top: 0px;" value="${pd.id }" >关闭</span>
						                            </div>
	                                     		</c:otherwise>
	                                     	</c:choose>
	                                    </td>
            ...
            if ($(t).hasClass("on")) {
            	$.ajax({
					...
					success : function(data, textStatus) {
						if(data.code == 1){
							 $(t).removeClass('on').html($(t).data("off-text"));   
						}
					},
            	...
            	$.ajax({
					...
					success : function(data, textStatus) {
						if(data.code == 1){
							$(t).addClass('on').html($(t).data("on-text"));
						}
					},
					complete : function(XMLHttpRequest, textStatus) {
						//HideLoading();
