...
public class GeneralAction extends BaseAction {
	...
	public String selNotice(){
		try {
			...
			generalService.selNotice(map);
			
		} catch (Exception e) {
			// TODO: handle exception
			log.error("查询公告积分异常",e);
			map.put("msg", "查询异常");
			map.put("code", 0);
		}
		return SUCCESS;
	...
	public String isRecommend(){
		try {
			...
			generalService.isRecommend(userId,type,map);
	...
	*/
	public String ym(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,price,10,map);
