	...
	*/
	public String wp(){
		try {
			...
			Jpush.SendPush(userId, "万普平台,应用《"+adname+"》获得"+points+"积分");
	...
	*/
	public String dl(){
		try {
			...
			Jpush.SendPush(userId, "点乐平台,"+adname+"获得"+points+"积分");
	...
	public String md(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,5,map);
			
			Jpush.SendPush(userId, "迷迪平台,应用《"+CommonUtil.changeIos8859ToUtf8(adname)+"》获得"+points+"积分");
	...
	public String dm(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,price,6,map);
			
			Jpush.SendPush(userId, "多盟平台,应用《"+adname+"》获得"+points+"积分");
	...
	public String mp(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,7,map);
	...
	*/
	public String zm(){
		try {
			...
			Jpush.SendPush(userId, "指盟平台,应用《"+adname+"》获得"+points+"积分");
	...
	public String yjf(){
		try {
			...
			Jpush.SendPush(userId, "易积分平台,应用《"+adname+"》获得"+points+"积分");
	...
	*/
	public String xy(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,10,map);
			
			Jpush.SendPush(userId, "行云平台,应用《"+adname+"》获得"+points+"积分");
	...
	public String gm(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,price,11,map);
			
			Jpush.SendPush(userId, "果盟平台,应用《"+CommonUtil.changeIos8859ToUtf8(adname)+"》获得"+points+"积分");
	...
	*/
	public String ck(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,12,map);
	...
	public String dr(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,13,map);
			
			Jpush.SendPush(userId, "点入平台,应用《"+CommonUtil.changeIos8859ToUtf8(adname)+"》获得"+points+"积分");
	...
	public String ym(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,price,14,map);
