...
public class QueryService {
	 ...
	 */
	@Transactional(readOnly = false,propagation=Propagation.REQUIRED)
	public void giveIntegral(String userId, String integral) {
		// TODO Auto-generated method stub
		...
		ui.setAdname("管理员赠送积分");
		ui.setIntergral(integral);
		ui.setPlatform(1);
		ui.setTime(DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"));
