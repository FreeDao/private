...
public class GeneralAction extends BaseAction {
	...
	public String dm(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,price,3,map);
	...
	*/
	...
	public String aw(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,2,map);
	...
	*/
	public String dl(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,6,map);
