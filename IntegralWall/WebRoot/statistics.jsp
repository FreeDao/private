                        ...
                        <div class="pull-right">
                        	...
                        	<div class="ui-select span3" id="qddiv" style="display: none;">
								<select name="qd" id="qd">
									<option value="1" selected="selected">手心</option>
									<option value="2">巨朋</option>
									<option value="3">点乐</option>
									<option value="4">迷迪</option>
									<option value="5">多盟</option>
									<option value="6">磨盘</option>
									<option value="7">安沃</option>
									<option value="8">有米</option>
									<option value="9">易积分</option>
									<option value="10">触控</option>
									<option value="11">力美</option>
								</select>
							</div>
