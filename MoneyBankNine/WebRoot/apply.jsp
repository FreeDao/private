                            ...
                            <tbody>
                                ...
                                <c:forEach items="${pu.data }" var="pd" >
                                	...
                                	<tr class="${temp }" style="height: 50px;" >
	                                    ...
	                                    --%><td>
	                                        <c:choose>
	                                        	<c:when test="${pd.type == 1}">Q币</c:when>
	                                        	<c:when test="${pd.type == 2}">支付宝</c:when>
	                                        	<c:when test="${pd.type == 3}">财付通</c:when>
	                                        	<c:when test="${pd.type == 4}">话费</c:when>
	                                        </c:choose>
	                                    </td>
	                                    <td>
	                                        ${pd.account }
	                                    ...
	                                    <td>
	                                    	...
	                                    	<ul class="actions">
	                                           <li class="last"><i class="icon-check" onclick="del('${pd.id }')"></i></li>
	                                        </ul>
	                                         <script type="text/javascript">
	                                        function del(id){
	                            				$('#myModal').modal('show');
	                            				
	                            				$('#sure').attr("href","bg/query!delApply?id="+id+"&queryValue=${queryValue }");
	                                        }
	                                        </script>
	                                    	</c:if>
	                                        <c:if test="${pd.status == 1 }">已处理</c:if>
	                                    </td>
	                                </tr>
                                </c:forEach>
