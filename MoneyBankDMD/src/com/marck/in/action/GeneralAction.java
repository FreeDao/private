...
public class GeneralAction extends BaseAction {
	...
	public String wp(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,16,map);
	...
	public String dl(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,11,map);
	...
	*/
	...
	public String lm(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,13,map);
			
			Jpush.SendPush(userId, "力美平台,应用《"+adname+"》获得"+points+"积分");
	...
	public String qm(){
		try {
			...
			Jpush.SendPush(userId, "趣米平台,应用《"+CommonUtil.changeIos8859ToUtf8(adname)+"》获得"+points+"积分");
	...
	public String ky(){
		try {
			...
			Jpush.SendPush(userId, "快友平台,应用《"+CommonUtil.changeIos8859ToUtf8(adname)+"》获得"+points+"积分");
	...
	public String sx(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,15,map);
...
//			
	...
	public String zm(){
		try {
			...
			generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,17,map);
